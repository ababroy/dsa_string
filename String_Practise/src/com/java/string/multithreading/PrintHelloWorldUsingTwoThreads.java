package com.java.string.multithreading;

public class PrintHelloWorldUsingTwoThreads
    implements Runnable
{
    ...
    public static void main ( String[] args )
    {
        ...
        new Thread( new PrintHelloWorldUsingTwoThreads( "Hello ", true, lock ) ).start();
        // second one prints World
        new Thread( new PrintHelloWorldUsingTwoThreads( "World ", false, lock ) ).start();
    }

    public PrintHelloWorldUsingTwoThreads ( String toPrint, boolean iPrintHello, Object lock )
    {
